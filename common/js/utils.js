...
const utils = {
  ...
  getGLContext(canvas) {
    return canvas.getContext('webgl2', {preserveDrawingBuffer: true}) || console.error('WebGL2 is not available in your browser.');
  },
   ...
   * @return {list} [r: 赤 (0~255), g: 緑 (0~255), b: 青 (0~255)]
   * @note https://note.kiriukun.com/entry/20181206-rgb-and-hsl-conversion
   */
  hsl2rgb(h, s, l) {
      const RGB_MAX = 255;
      const HUE_MAX = 360;
